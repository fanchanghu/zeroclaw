    ...
    pub fn build(self) -> Result<Agent> {
        ...
        Ok(Agent {
            ...
            memory_strategy: self.memory_strategy.unwrap_or_else(|| {
                Arc::new(crate::agent::memory_strategy::DefaultMemoryStrategy::with_config(
                    memory.clone(),
...
impl Agent {
    ...
    async fn from_config_with_session_cwd_and_mcp_approval_mode(
        ...
        let mut agent = Agent::builder()
            ...
            .memory_strategy(Arc::new(crate::agent::memory_strategy::DefaultMemoryStrategy::with_config(
                memory.clone(),
                config.memory.clone(),
