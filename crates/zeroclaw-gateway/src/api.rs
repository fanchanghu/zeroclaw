...
mod tests {
    ...
    fn test_state(config: zeroclaw_config::schema::Config) -> AppState {
        AppState {
            ...
            memory_strategy: Arc::new(zeroclaw_runtime::agent::memory_strategy::DefaultMemoryStrategy::with_config(Arc::new(MockMemory), zeroclaw_config::schema::MemoryConfig::default(), std::path::PathBuf::new())),
            auto_save: false,
